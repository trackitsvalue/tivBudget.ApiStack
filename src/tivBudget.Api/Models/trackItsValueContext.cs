...
{
    public partial class trackItsValueContext : DbContext
    {
        public trackItsValueContext()
        {
        }

        public trackItsValueContext(DbContextOptions<trackItsValueContext> options)
            : base(options)
        {
        }

        public virtual DbSet<AccountActualRecurrences> AccountActualRecurrences { get; set; }
        public virtual DbSet<AccountActuals> AccountActuals { get; set; }
        public virtual DbSet<AccountActualTemplates> AccountActualTemplates { get; set; }
        public virtual DbSet<AccountCategories> AccountCategories { get; set; }
        public virtual DbSet<AccountCategoryTemplates> AccountCategoryTemplates { get; set; }
        public virtual DbSet<Accounts> Accounts { get; set; }
        public virtual DbSet<AccountTemplates> AccountTemplates { get; set; }
        public virtual DbSet<AccountTypes> AccountTypes { get; set; }
        public virtual DbSet<Applications> Applications { get; set; }
        public virtual DbSet<BudgetActuals> BudgetActuals { get; set; }
        public virtual DbSet<BudgetCategories> BudgetCategories { get; set; }
        public virtual DbSet<BudgetCategoryTemplates> BudgetCategoryTemplates { get; set; }
        public virtual DbSet<BudgetItemAlerts> BudgetItemAlerts { get; set; }
        public virtual DbSet<BudgetItemRecurringSettings> BudgetItemRecurringSettings { get; set; }
        public virtual DbSet<BudgetItems> BudgetItems { get; set; }
        public virtual DbSet<BudgetItemTemplates> BudgetItemTemplates { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<AccountActualRecurrences>(entity =>
            {
            ...
            modelBuilder.Entity<AccountActuals>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .ForSqlServerIsClustered(false);
            ...
            modelBuilder.Entity<AccountActualTemplates>(entity =>
            {
            ...
            modelBuilder.Entity<AccountCategoryTemplates>(entity =>
            {
            ...
            modelBuilder.Entity<AccountTemplates>(entity =>
            {
            ...
            modelBuilder.Entity<BudgetActuals>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .ForSqlServerIsClustered(false);
            ...
            modelBuilder.Entity<BudgetCategoryTemplates>(entity =>
            {
            ...
            modelBuilder.Entity<BudgetItemAlerts>(entity =>
            {
            ...
            modelBuilder.Entity<BudgetItemRecurringSettings>(entity =>
            {
            ...
            modelBuilder.Entity<BudgetItemTemplates>(entity =>
            {
